		...
		<div id="list-especialidad" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="disponible" title="${message(code: 'especialidad.disponible.label', default: 'Disponible')}" />
				...
				<g:each in="${especialidadInstanceList}" status="i" var="especialidadInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${especialidadInstance.id}">${fieldValue(bean: especialidadInstance, field: "descripcion")}</g:link></td>
					
						<td><g:formatBoolean boolean="${especialidadInstance.disponible}" /></td>
			...
			<div class="pagination">
				<g:paginate total="${especialidadInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
